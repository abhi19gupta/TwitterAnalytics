...
The :mod:`ingest_neo4j_streaming` module contains the classes:

- :class:`ingest_neo4j_streaming.Twitter`

One can use the :func:`ingest_neo4j_streaming.Twitter.ingest_tweet` to insert a new tweet into the database.
