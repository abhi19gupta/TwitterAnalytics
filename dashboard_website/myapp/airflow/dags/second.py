...
types = \
{'q10': 'neo4j', 'q3': 'neo4j', 'q4': 'neo4j', 'q5': 'mongoDB', 'q6': 'mongoDB', 'q7': 'neo4j'}
provided_inputs = \
{'n1': {'num': 5}, 'n2': {}, 'n3': {}}
mapping = \
{'n1': {'num': '-'}, 'n2': {'hash': ('n1', '_id')}, 'n3': {'xid': ('n2', 'u.id')}}
node_to_query = \
{'n1': 'q6', 'n2': 'q4', 'n3': 'q7'}
...
dag = DAG(dag_id='second', default_args=args,schedule_interval=None)
...
def execute_query(node_name,**context):
	...
	for x in input_vars:
		if(mapping[node_name][x]=="-"):	
			...
			inp = context['task_instance'].xcom_pull(task_ids=get_task_from_node(mapp[0]),dag_id = "second",key=mapp[1])
			print(inp)
			inputs[x] = inp
	print("========================================")
